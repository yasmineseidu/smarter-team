...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/payment-collection.md
**Created:** 2025-12-06

## Summary

Implement the Payment-Collection Agent with all tools, tests, and integrations as specified in the production spec.

## Agent Details

**Category:** Payment & Finance
**Phase:** High (revenue critical path)
**Dependencies:** None

## Files to Create/Modify

- [ ] `app/backend/src/agents/payment-collection/__init__.py`
- [ ] `app/backend/src/agents/payment-collection/agent.py`
- [ ] `app/backend/src/agents/payment-collection/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_payment-collection_agent.py`
- [ ] `app/backend/__tests__/integration/test_payment-collection_integration.py`
- [ ] `app/backend/__tests__/fixtures/payment-collection_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Payment-CollectionAgent` class extending BaseAgent
...
pytest --cov=src/agents/payment-collection --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_payment-collection_agent.py -v
pytest __tests__/integration/test_payment-collection_integration.py -v
...
All criteria from `specs/agents/payment-collection.md` must be met:
...
- See full specification in `specs/agents/payment-collection.md` for:
