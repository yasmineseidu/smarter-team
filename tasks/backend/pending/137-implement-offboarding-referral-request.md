# Task: Implement Offboarding-Referral-Request Agent

**Status:** Pending
**Domain:** backend
**Source:** specs/agents/offboarding-referral-request.md
**Created:** 2025-12-06

## Summary

Implement the Offboarding-Referral-Request Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/offboarding-referral-request/__init__.py`
- [ ] `app/backend/src/agents/offboarding-referral-request/agent.py`
- [ ] `app/backend/src/agents/offboarding-referral-request/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_offboarding-referral-request_agent.py`
- [ ] `app/backend/__tests__/integration/test_offboarding-referral-request_integration.py`
- [ ] `app/backend/__tests__/fixtures/offboarding-referral-request_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Offboarding-Referral-RequestAgent` class extending BaseAgent
...
- [ ] Create/verify database schema:
  ...
  - [ ] `referrals` table
  - [ ] `referral_incentives` table
  - [ ] `referral_payouts` table
  - [ ] `referral_analytics` table
...
pytest --cov=src/agents/offboarding-referral-request --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_offboarding-referral-request_agent.py -v
pytest __tests__/integration/test_offboarding-referral-request_integration.py -v
...
All criteria from `specs/agents/offboarding-referral-request.md` must be met:
...
- See full specification in `specs/agents/offboarding-referral-request.md` for:
