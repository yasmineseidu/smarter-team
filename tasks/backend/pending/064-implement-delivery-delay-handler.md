...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/delivery-delay-handler.md
**Created:** 2025-12-06

## Summary

Implement the Delivery-Delay-Handler Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/delivery-delay-handler/__init__.py`
- [ ] `app/backend/src/agents/delivery-delay-handler/agent.py`
- [ ] `app/backend/src/agents/delivery-delay-handler/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_delivery-delay-handler_agent.py`
- [ ] `app/backend/__tests__/integration/test_delivery-delay-handler_integration.py`
- [ ] `app/backend/__tests__/fixtures/delivery-delay-handler_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Delivery-Delay-HandlerAgent` class extending BaseAgent
- [ ] Define `system_prompt` property
- [ ] Implement `process_task()` method with task routing
- [ ] Register all tools in `_register_tools()`

### Phase 2: Tool Implementation
- [ ] Implement `detect_delays()` tool
- [ ] Implement `analyze_delay_impact()` tool
- [ ] Implement `draft_delay_communication()` tool
- [ ] Implement `submit_for_approval()` tool
- [ ] Implement `send_approved_communication()` tool
- [ ] Implement `update_project_schedule()` tool
...
pytest --cov=src/agents/delivery-delay-handler --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_delivery-delay-handler_agent.py -v
pytest __tests__/integration/test_delivery-delay-handler_integration.py -v
...
All criteria from `specs/agents/delivery-delay-handler.md` must be met:
...
- See full specification in `specs/agents/delivery-delay-handler.md` for:
...
**Next available task number: 114**
