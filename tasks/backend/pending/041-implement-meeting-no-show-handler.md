...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/meeting-no-show-handler.md
**Created:** 2025-12-06

## Summary

Implement the Meeting-No-Show-Handler Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/meeting-no-show-handler/__init__.py`
- [ ] `app/backend/src/agents/meeting-no-show-handler/agent.py`
- [ ] `app/backend/src/agents/meeting-no-show-handler/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_meeting-no-show-handler_agent.py`
- [ ] `app/backend/__tests__/integration/test_meeting-no-show-handler_integration.py`
- [ ] `app/backend/__tests__/fixtures/meeting-no-show-handler_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Meeting-No-Show-HandlerAgent` class extending BaseAgent
...
- [ ] Create/verify database schema:
  - [ ] `no_show_logs` table
  - [ ] `reschedule_attempts` table
  - [ ] `reactivation_pool` table
...
pytest --cov=src/agents/meeting-no-show-handler --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_meeting-no-show-handler_agent.py -v
pytest __tests__/integration/test_meeting-no-show-handler_integration.py -v
...
All criteria from `specs/agents/meeting-no-show-handler.md` must be met:
...
- See full specification in `specs/agents/meeting-no-show-handler.md` for:
...
**Next available task number: 127**
