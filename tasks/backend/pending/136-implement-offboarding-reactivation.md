# Task: Implement Offboarding-Reactivation Agent

**Status:** Pending
**Domain:** backend
**Source:** specs/agents/offboarding-reactivation.md
**Created:** 2025-12-06

## Summary

Implement the Offboarding-Reactivation Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/offboarding-reactivation/__init__.py`
- [ ] `app/backend/src/agents/offboarding-reactivation/agent.py`
- [ ] `app/backend/src/agents/offboarding-reactivation/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_offboarding-reactivation_agent.py`
- [ ] `app/backend/__tests__/integration/test_offboarding-reactivation_integration.py`
- [ ] `app/backend/__tests__/fixtures/offboarding-reactivation_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Offboarding-ReactivationAgent` class extending BaseAgent
...
- [ ] Create/verify database schema:
  - [ ] `reactivation_pools` table
  - [ ] `reactivation_triggers` table
  - [ ] `reactivation_campaigns` table
  - [ ] `reactivation_monitoring` table
...
pytest --cov=src/agents/offboarding-reactivation --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_offboarding-reactivation_agent.py -v
pytest __tests__/integration/test_offboarding-reactivation_integration.py -v
...
All criteria from `specs/agents/offboarding-reactivation.md` must be met:
...
- See full specification in `specs/agents/offboarding-reactivation.md` for:
