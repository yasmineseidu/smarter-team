...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/retention-satisfaction-survey.md
**Created:** 2025-12-06

## Summary

Implement the Retention-Satisfaction-Survey Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/retention-satisfaction-survey/__init__.py`
- [ ] `app/backend/src/agents/retention-satisfaction-survey/agent.py`
- [ ] `app/backend/src/agents/retention-satisfaction-survey/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_retention-satisfaction-survey_agent.py`
- [ ] `app/backend/__tests__/integration/test_retention-satisfaction-survey_integration.py`
- [ ] `app/backend/__tests__/fixtures/retention-satisfaction-survey_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Retention-Satisfaction-SurveyAgent` class extending BaseAgent
- [ ] Define `system_prompt` property
- [ ] Implement `process_task()` method with task routing
- [ ] Register all tools in `_register_tools()`

### Phase 2: Tool Implementation
- [ ] Implement `create_survey()` tool
- [ ] Implement `send_survey_invitation()` tool
- [ ] Implement `analyze_survey_response()` tool
- [ ] Implement `generate_satisfaction_alert()` tool
- [ ] Implement `request_testimonial()` tool
- [ ] Implement `calculate_satisfaction_trends()` tool
- [ ] Implement `sync_survey_responses()` tool
...
pytest --cov=src/agents/retention-satisfaction-survey --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_retention-satisfaction-survey_agent.py -v
pytest __tests__/integration/test_retention-satisfaction-survey_integration.py -v
...
All criteria from `specs/agents/retention-satisfaction-survey.md` must be met:
...
- See full specification in `specs/agents/retention-satisfaction-survey.md` for:
...
**Next available task number: 164**
