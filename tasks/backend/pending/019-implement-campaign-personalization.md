# Task: Implement Campaign-Personalization Agent

**Status:** Pending
**Domain:** backend
**Source:** specs/agents/campaign-personalization.md
**Created:** 2025-12-06

## Summary

Implement the Campaign-Personalization Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/campaign-personalization/__init__.py`
- [ ] `app/backend/src/agents/campaign-personalization/agent.py`
- [ ] `app/backend/src/agents/campaign-personalization/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_campaign-personalization_agent.py`
- [ ] `app/backend/__tests__/integration/test_campaign-personalization_integration.py`
- [ ] `app/backend/__tests__/fixtures/campaign-personalization_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Campaign-PersonalizationAgent` class extending BaseAgent
...
### Phase 3: Integration
- [ ] Implement ### 1. Claude API (Anthropic) client integration
- [ ] Add error handling with retry logic for ### 1. Claude API (Anthropic)
- [ ] Add rate limiting for ### 1. Claude API (Anthropic)


### Phase 4: Database
- [ ] Create/verify database schema:
  - [ ] `personalization_lines` table
  - [ ] `personalization_sources` table
  - [ ] `personalization_performance` table
...
pytest --cov=src/agents/campaign-personalization --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_campaign-personalization_agent.py -v
pytest __tests__/integration/test_campaign-personalization_integration.py -v
...
All criteria from `specs/agents/campaign-personalization.md` must be met:
...
- See full specification in `specs/agents/campaign-personalization.md` for:
...
**Next available task number: 106**
