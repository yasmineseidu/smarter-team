...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/retention-upsell-detector.md
**Created:** 2025-12-06

## Summary

Implement the Retention-Upsell-Detector Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/retention-upsell-detector/__init__.py`
- [ ] `app/backend/src/agents/retention-upsell-detector/agent.py`
- [ ] `app/backend/src/agents/retention-upsell-detector/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_retention-upsell-detector_agent.py`
- [ ] `app/backend/__tests__/integration/test_retention-upsell-detector_integration.py`
- [ ] `app/backend/__tests__/fixtures/retention-upsell-detector_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Retention-Upsell-DetectorAgent` class extending BaseAgent
...
- [ ] Create/verify database schema:
  - [ ] `upsell_opportunities` table
  - [ ] `upsell_signals` table
...
pytest --cov=src/agents/retention-upsell-detector --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_retention-upsell-detector_agent.py -v
pytest __tests__/integration/test_retention-upsell-detector_integration.py -v
...
All criteria from `specs/agents/retention-upsell-detector.md` must be met:
...
- See full specification in `specs/agents/retention-upsell-detector.md` for:
...
**Next available task number: 166**
