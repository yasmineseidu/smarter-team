...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/offboarding-knowledge-transfer.md
**Created:** 2025-12-06

## Summary

Implement the Offboarding-Knowledge-Transfer Agent with all tools, tests, and integrations as specified in the production spec.

## Agent Details

**Category:** Offboarding & Nurture
**Phase:** High (critical for client retention and successful offboarding)
**Dependencies:** None

## Files to Create/Modify

- [ ] `app/backend/src/agents/offboarding-knowledge-transfer/__init__.py`
- [ ] `app/backend/src/agents/offboarding-knowledge-transfer/agent.py`
- [ ] `app/backend/src/agents/offboarding-knowledge-transfer/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_offboarding-knowledge-transfer_agent.py`
- [ ] `app/backend/__tests__/integration/test_offboarding-knowledge-transfer_integration.py`
- [ ] `app/backend/__tests__/fixtures/offboarding-knowledge-transfer_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Offboarding-Knowledge-TransferAgent` class extending BaseAgent
...
pytest --cov=src/agents/offboarding-knowledge-transfer --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_offboarding-knowledge-transfer_agent.py -v
pytest __tests__/integration/test_offboarding-knowledge-transfer_integration.py -v
...
All criteria from `specs/agents/offboarding-knowledge-transfer.md` must be met:
...
- See full specification in `specs/agents/offboarding-knowledge-transfer.md` for:
...
**Next available task number: 135**
