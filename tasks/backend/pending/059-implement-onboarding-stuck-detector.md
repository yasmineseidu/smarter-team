...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/onboarding-stuck-detector.md
**Created:** 2025-12-06

## Summary

Implement the Onboarding-Stuck-Detector Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/onboarding-stuck-detector/__init__.py`
- [ ] `app/backend/src/agents/onboarding-stuck-detector/agent.py`
- [ ] `app/backend/src/agents/onboarding-stuck-detector/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_onboarding-stuck-detector_agent.py`
- [ ] `app/backend/__tests__/integration/test_onboarding-stuck-detector_integration.py`
- [ ] `app/backend/__tests__/fixtures/onboarding-stuck-detector_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Onboarding-Stuck-DetectorAgent` class extending BaseAgent
...
pytest --cov=src/agents/onboarding-stuck-detector --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_onboarding-stuck-detector_agent.py -v
pytest __tests__/integration/test_onboarding-stuck-detector_integration.py -v
...
All criteria from `specs/agents/onboarding-stuck-detector.md` must be met:
...
- See full specification in `specs/agents/onboarding-stuck-detector.md` for:
