# Task: Implement System-Agent-Performance-Analyst Agent

**Status:** Pending
**Domain:** backend
**Source:** specs/agents/system-agent-performance-analyst.md
**Created:** 2025-12-06

## Summary

Implement the System-Agent-Performance-Analyst Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/system-agent-performance-analyst/__init__.py`
- [ ] `app/backend/src/agents/system-agent-performance-analyst/agent.py`
- [ ] `app/backend/src/agents/system-agent-performance-analyst/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_system-agent-performance-analyst_agent.py`
- [ ] `app/backend/__tests__/integration/test_system-agent-performance-analyst_integration.py`
- [ ] `app/backend/__tests__/fixtures/system-agent-performance-analyst_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `System-Agent-Performance-AnalystAgent` class extending BaseAgent
...
pytest --cov=src/agents/system-agent-performance-analyst --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_system-agent-performance-analyst_agent.py -v
pytest __tests__/integration/test_system-agent-performance-analyst_integration.py -v
...
All criteria from `specs/agents/system-agent-performance-analyst.md` must be met:
...
- See full specification in `specs/agents/system-agent-performance-analyst.md` for:
