# Task: Implement Onboarding-Orchestrator Agent

**Status:** Pending
**Domain:** backend
**Source:** specs/agents/onboarding-orchestrator.md
**Created:** 2025-12-06

## Summary

Implement the Onboarding-Orchestrator Agent with all tools, tests, and integrations as specified in the production spec.
...
- [ ] `app/backend/src/agents/onboarding-orchestrator/__init__.py`
- [ ] `app/backend/src/agents/onboarding-orchestrator/agent.py`
- [ ] `app/backend/src/agents/onboarding-orchestrator/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_onboarding-orchestrator_agent.py`
- [ ] `app/backend/__tests__/integration/test_onboarding-orchestrator_integration.py`
- [ ] `app/backend/__tests__/fixtures/onboarding-orchestrator_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Onboarding-OrchestratorAgent` class extending BaseAgent
...
- [ ] Implement Deformity client integration
- [ ] Add error handling with retry logic for Deformity
- [ ] Add rate limiting for Deformity
...
pytest --cov=src/agents/onboarding-orchestrator --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_onboarding-orchestrator_agent.py -v
pytest __tests__/integration/test_onboarding-orchestrator_integration.py -v
...
All criteria from `specs/agents/onboarding-orchestrator.md` must be met:
...
- See full specification in `specs/agents/onboarding-orchestrator.md` for:
...
**Next available task number: 140**
