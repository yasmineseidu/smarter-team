...
**Status:** Pending
**Domain:** backend
**Source:** specs/agents/campaign-copywriting.md
**Created:** 2025-12-06

## Summary

Implement the Campaign-Copywriting Agent with all tools, tests, and integrations as specified in the production spec.

## Agent Details

**Category:** Unknown
**Phase:** Phase 1
**Dependencies:** - Niche Research Agent (provides niche context and pain points)

## Files to Create/Modify

- [ ] `app/backend/src/agents/campaign-copywriting/__init__.py`
- [ ] `app/backend/src/agents/campaign-copywriting/agent.py`
- [ ] `app/backend/src/agents/campaign-copywriting/tools.py`
- [ ] `app/backend/__tests__/unit/agents/test_campaign-copywriting_agent.py`
- [ ] `app/backend/__tests__/integration/test_campaign-copywriting_integration.py`
- [ ] `app/backend/__tests__/fixtures/campaign-copywriting_fixtures.py`

## Implementation Checklist

### Phase 1: Agent Class Setup
- [ ] Create agent directory structure
- [ ] Implement `Campaign-CopywritingAgent` class extending BaseAgent
...
pytest --cov=src/agents/campaign-copywriting --cov-report=term-missing

# Run specific agent tests
pytest __tests__/unit/agents/test_campaign-copywriting_agent.py -v
pytest __tests__/integration/test_campaign-copywriting_integration.py -v
...
All criteria from `specs/agents/campaign-copywriting.md` must be met:
...
- See full specification in `specs/agents/campaign-copywriting.md` for:
