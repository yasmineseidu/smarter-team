...
Read file: .claude/context/SDK_PATTERNS.md      # Claude Agent SDK API, tools, hooks
...
- [ ] **SDK_PATTERNS.md** - Understand Claude Agent SDK patterns for spec design
- [ ] **TASK_RULES.md** - Know where to place files and create tasks

**YOU CANNOT PROCEED WITH DESIGN UNTIL THESE FILES ARE READ.**
...
**Remember: Great architecture comes from thorough research and careful planning. Take time to design it right.**
