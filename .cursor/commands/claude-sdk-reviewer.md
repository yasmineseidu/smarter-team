...
```
Read file: .claude/context/SDK_PATTERNS.md        # Claude Agent SDK patterns to verify against
...
### Context Checklist
- [ ] **SDK_PATTERNS.md** - Know correct SDK patterns to review against
...
**YOU CANNOT PROCEED WITH REVIEW UNTIL THESE FILES ARE READ.**
...
Always prioritize security, correctness, and maintainability while ensuring full compliance with Claude Agent SDK best practices. Your thoroughness protects the codebase.
