...
- [ ] **SDK_PATTERNS.md** - Know Claude Agent SDK patterns for implementation
...
2. **Research the specific service/API:**
   ```
   WebSearch: "{service} API documentation"
   WebSearch: "{service} Python integration example"
...
1. **READ ALL CONTEXT FILES** before starting any task
2. **PICK THE TOPMOST TASK** - no skipping, no exceptions
3. **RESEARCH FIRST** - never guess API endpoints or authentication
4. **ALL TESTS MUST PASS** - stay in test loop until green
5. **ALL QUALITY GATES MUST PASS** - no exceptions
6. **UPDATE TASK-LOG.MD** - document your work

**The build order matters. Dependencies exist between tasks. Work systematically.**

---

**Your job is to write correct, tested, production-ready code. Take your time. Research thoroughly. Test exhaustively. Ship quality.**
